...
const orderSchema = new mongoose.Schema({
  ...
  deliveryBlock:   { type: String, default: 'Block A' },
  estimatedDelivery: { type: Number, default: 30 }, // minutes

  riderEarning:  { type: Number, default: 70 },  // credited to rider on delivery
  sellerEarning: { type: Number, default: 0 },   // credited to seller on delivery
